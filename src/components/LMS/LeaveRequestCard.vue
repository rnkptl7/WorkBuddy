  ...
  >
    <div class="d-flex flex-row w-100">
      ...
      <div class="ld-card-body d-flex flex-column mx-4 mb-5">
        ...
        <h5 class="mt-1" v-if="isAdmin">Created By: {{ leave.createdBy }}</h5>
        <div class="ld-category d-flex flex-row my-3">
          <span class="border rounded-pill px-2 text-caption text-uppercase">{{
            leave.leaveCategory
          }}</span>
        </div>
    ...
    <div>
      <v-btn rounded color="blue" @click="dialog = true">View Details</v-btn>
          ...
          <div class="pa-5">
            <div class="ld-card-body">
              <div class="d-flex flex-row justify-space-between align-center">
                <div class="ld-category d-flex flex-row align-center">
              ...
              <div class="ld-card_logo d-flex flex-row align-center">
                <h3>From</h3>
                <span>
                  {{ leave.startDate }}
                </span>
              ...
              <h5 v-if="isAdmin">Created By: {{ leave.createdBy }}</h5>
  ...
  if (action == "reject") {
    await updateDoc(user, {
      leavesDetails: {
        ...
        takenLeaves: leaveCountDetails.value.takenLeaves - leave.totalDays,
        leftLeaves: leaveCountDetails.value.leftLeaves + leave.totalDays,
      },
    });
    leavesStore.leaveCountDetails = {
      TOTAL_LEAVES: leavesStore.leaveCountDetails.TOTAL_LEAVES,
      takenLeaves: leavesStore.leaveCountDetails.takenLeaves - leave.totalDays,
      leftLeaves: leavesStore.leaveCountDetails.leftLeaves + leave.totalDays,
    };
  }
