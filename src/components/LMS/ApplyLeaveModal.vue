      ...
      <v-container class="pa-3">
        ...
        >
          <div class="inputDiv">
            ...
            >
              <select name="category" class="input" v-bind="field">
          ...
          <div class="inputDiv">
            ...
            />
            <ErrorMessage name="leaveMessage" class="error_message" />
          </div>

          <div class="inputDiv flex-column justify-space-around w-100">
            <div class="date_input_wrapper w-50">
              ...
              />
              <ErrorMessage name="startDate" class="error_message" />
            </div>
            <div class="date_input_wrapper w-50">
              ...
              />
              <ErrorMessage name="endDate" class="error_message" />
            </div>
          </div>
          ...
          <div class="inputDiv">
            ...
            />
            <ErrorMessage name="requestingToEmail" class="error_message" />
          </div>
    ...
    if (value) {
      ...
      if (leaveRequestInput.leaveCategory == "Unplanned") {
        ...
        return date > yesterday
          ? true
          : `Start Date should above ${moment(yesterday).format("DD-MM-YYYY")}`;
      }
    ...
    if (value) {
      ...
      if (leaveRequestInput.startDate > date) {
        ...
        if (leaveRequestInput.leaveCategory == "Unplanned") {
          ...
          totalDays =
            (tomorrow.getTime() - yesterday.getTime()) / (1000 * 3600 * 24);
        } else if (leaveRequestInput.leaveCategory == "Planned") {
          tomorrow.setDate(
            tomorrow.getDate() + leaveCountDetails.value.leftLeaves - 1
          );
          totalDays =
            (tomorrow.getTime() - yesterday.getTime()) / (1000 * 3600 * 24);
          if (
